...
#
# Usage:
#   scripts/release.sh v0.1.0            # Create and push tag
#   scripts/release.sh v0.1.0 --dry-run  # Run checks only, don't tag
#
set -euo pipefail
...
if [[ -z "$VERSION" ]]; then
    ...
    echo "  scripts/release.sh v0.1.0 --dry-run"
...
if [[ "$DRY_RUN" == "true" ]]; then
    ...
    info "Watch progress: https://github.com/biao29/hush/actions"
fi
